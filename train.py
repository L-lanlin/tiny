...
parser.add_argument('--decay_epoch', type=int, default=6, help='epoch from which to start lr decay')
...
voc = VOCDetection('/opt/VOCccf/', high_resolution=(opt.hr_height, opt.hr_width))
